...
Page {
    id: editorRoot
    property string questionType : "choice"
    property string widgetPath : "qrc:/ui/QuestionWidgets/TypeInQuestionEditor.qml"
...
//        }
        ...
        ComboBox {
            ...
            editable: true
            currentIndex: -1
            displayText: currentIndex === -1 ? "New theme" : currentText
            model: ListModel {
                id: themeModel
...
//    }
    ...
    function save() {
        const theme = themeName.displayText
        ...
        try {
            editorStub.children[0].saveQuestion(theme, difficulty)
        } catch(e) {
