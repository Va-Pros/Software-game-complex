...
OneColumnAnswersQuestionEditor {
    ...
    beforeAnswerTextField: Qt.createComponent("SingleChoiceAnswerInput.qml")
    beforeAnswerTextFieldProperties: (function() { return { buttonGroup: answerRadioGroup} })()
    beforeAnswerTextFieldSetup: function(element) {  }
